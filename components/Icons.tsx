...
export const PaintBrushIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.47 2.118v-.09A18.32 18.32 0 0118.375 7.42c.395.03.79.062 1.185.097a2.25 2.25 0 012.639 2.476 3 3 0 00-1.128 5.78l-2.47-2.47a.75.75 0 00-1.06 0l-2.47 2.47zM12 12.75a.75.75 0 00-1.06 0l-2.47 2.47-2.47-2.47a.75.75 0 00-1.06 0L3.625 15.625a.75.75 0 000 1.06l2.47 2.47 2.47-2.47a.75.75 0 000-1.06L6.375 14.375l2.47-2.47a.75.75 0 000-1.06l-2.47-2.47-2.47 2.47a.75.75 0 000 1.06l2.47 2.47 2.47-2.47a.75.75 0 00-1.06 0l-2.47 2.47 2.47 2.47a.75.75 0 001.06 0l2.47-2.47a.75.75 0 000-1.06l-2.47-2.47z" />
    </svg>
);
